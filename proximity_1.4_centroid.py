...
targetsverb = input("What is the target verb?")
targetsform = input("Is this formulaic (form) or comparison (comp)?")
...
directory = os.path.join("C:\\Users", "Martina Astrid Rodda", "Documents", "uni", "dphil", "year 2", "turing onedrive backup",
                         "MAR dphil project")
...
dir_targets = os.path.join(directory, "thesis formulae")
...
targets_file_name = "targets_" + str(targetsform) + "_" + str(targetsverb) + ".csv"

# Output files:
file_out_cos_distance = str(targetsverb) + "_" + str(targetsform) + "_cos_distance" + str(window) + "_t" + str(freq_threshold) + "_centroid.csv"
